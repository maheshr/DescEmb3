...
python main.py --input_path %DST_PATH% --model ehr_model --embed_model descemb_bert --pred_model rnn --src_data pooled --eval_data %EVAL_DATA% --ratio 100 --value_mode DSVA --task %LABEL% --batch_size 64
