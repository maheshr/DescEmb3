...
python ../preprocess/preprocess_main.py --src_data eicu --dataset_path %SRC_PATH%\eicu --dest_path %DST_PATH% --data_type pretrain --value_mode VC
...
python ../preprocess/preprocess_main.py --src_data eicu --dataset_path %SRC_PATH%\eicu --dest_path %DST_PATH% --data_type predict --value_mode VC
...
python ../preprocess/preprocess_main.py --src_data pooled --dataset_path %SRC_PATH%\ --dest_path %DST_PATH% --data_type predict --value_mode VC
python ../preprocess/preprocess_main.py --src_data pooled --dataset_path %SRC_PATH%\ --dest_path %DST_PATH% --data_type pretrain --value_mode VC
